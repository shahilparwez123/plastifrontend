    ...
    return (
        ...
        py-10 sm:py-20 relative overflow-hidden'>
            ...
            xl:gap-16 relative'>
                <div className=' w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
                    <div className=' space-y-4 sm:space-y-8 px-4 sm:px-0'>
                        ...
                        italic border-1-4 bg-amber-500/60 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent'>
                            "At Plasti-Pro, precision manufacturing and sustainable materials come together to create paper plates and crockery that serve every occasion with strength, hygiene, and care."
                        </p>
                    </div>
                ...
                group transfrom hover:sacle-[1.01] transition-all duration-500'>
                    <div className=' relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition
