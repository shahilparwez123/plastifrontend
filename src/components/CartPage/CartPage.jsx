...
const API_URL = 'https://plastibackend.onrender.com';
const CartPage = () => {
    ...
    return(
        <div className=' min-h-screen overflow-x-hidden py-16 px-4 sm:px-6 lg:px-6 bg-gradient-to-br from-[#1a120b] via-[#2a1e14]
        to-[#3e2b1d]'>
            <div className=' max-w-7xl mx-auto'>
                ...
                {cartItems.length === 0 ? (
                    <div className=' text-center animate-fade-in'>
                        ...
                        <Link to='/products' className= 'transition-all duration-300 text-amber-100 inline-flex items-center gap-2 hover:gap-3 hover:bg-amber-800/50 bg-amber-900/40 px-6 py-2 rounded-full font-cinzel text-sm uppercase'>
                        Browser All Items
                        </Link>
                        </div>
                ):(
                    <>
                            ...
                            .map(({ _id, item, quantity}) => (
                                ...
                                transform hover: -translate-y-1 animate-fade-in'>
                                    ...
                                    <div className=' w-full text-center'>
                                        ...
                                        <p className=' text-amber-100/80 font-cinzel mt-1'>₹{Number(item?.price || 0).toFixed(2)}</p>
                                    </div>
                        ...
                        <div className=' flex flex-col sm:flex-row justify-between items-center gap-8'>
                            <Link to='/products' className=' bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase
            ...
            {selectedImage && (
                <div className=' fixed inset-0 z-50 flex items-center justify-center bg-amber-900/40 bg-opacity-75 backdrop-blur
                p-4 overflow-auto'
