    ...
    return(
        ...
        className=' py-16 px-4 text-center relative'>
            <div className=' max-w-4xl mx-auto'>
                ...
                bg-gradient-to-r from-amber-500 to-yellow-600 leading-tight'>
                Driven by Quality
                </motion.h1>
                <motion.p initial={{ opacity:0}} animate={{ opacity: 1}}>
                    Combining technology, sustainability, and strength in every product we create
                </motion.p>
            </div>
            ...
            {features.map((f,i)=> {
                ...
                return(
                    ...
                    transition={{delay: i*0.2}} className=' relative group'>
                        <div className=' absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30 rounded-xl
                ...
                return(
                    ...
                    animate={{
                        ...
                        <motion.div className=' absolute inset-0' animate={{
                            y: [0, -15, 0],
                            transition:{
                                duration: 4, repeat: Infinity, ease: "easeInOut", delay: i*0.3
                            }
                        }}>
                                ...
                                <motion.div className=' absolute inset-0 rounded-xl'
                                 ...
                                 <div className=' absolute inset-0 z-10 h-full flex flex-col items-center justify-center'>
                                    ...
                                    whileHover={{scale:1.1 , rotate: 10}}>
                                        ...
                                        <motion.div
                                    className='text-xs sm:text-sm uppercase font-semibold text-center
                                             text-amber-100/80 leading-snug max-w-[140px]'
                                                animate={{
                                                             letterSpacing: hoveredStat === i ? '0.08em' : '0.05em',
                                                     }}
                                                                    >
                                            {s.label}
                                            </motion.div>
                                        ...
                                        initial={{ opacity: 0}}
                                        aniamte={{ opacity: hoveredStat === i ? 1: 0}}/>       
        ...
        <section className=' py-16 px-4 md:px-8 relative'>
            <div className=' max-w-7xl mx-auto'>
                ...
                <div className=' grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12'>
                    {teamMembers.map((m,i) => (
                    ...
                    transition={{ delay: m.delay}} className=' relative group'>
                        ...
                        hover:shadow-2xl hover:shadow-amber-500/20'>
                            ...
                            <div className=' p-8 text-center flex flex-col h-[cal(100%-24rem)]'>
                                <div className=' mb-4'>
                                    <h3 className=' text-3xl font-bold mb-2 text-amber-1000'>{m.name}</h3>
                                    <p className=' text-amber-500 text-lg font-medium font-cursive'>
                                        {m.role}
                                    </p>
                                </div>

                                <p className=' text-amber-100/100 text-lg font-cursive flex-grew'>
                                {m.bio}
                                </p>
                            </div>
                        </div>
